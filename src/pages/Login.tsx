                    ...
                    <div className="w-full lg:flex-1 max-w-[420px] mx-auto lg:mx-0">
                        <div className="bg-white rounded-[24px] shadow-[0_8px_20px_rgba(0,0,0,0.06)] p-[28px] md:p-[36px] lg:p-[40px]">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="password" title="Enter your password" id="password-label" className="text-sm font-semibold text-[#0E2F44]">
                                        Password
                                    </Label>
                                    <Input
                                        id="password"
                            ...
                            <Button
                                ...
                                className="w-full h-11 rounded-full border-2 border-[#E5F4F9] hover:bg-[#F2FAFD] transition-all flex items-center justify-center gap-2 font-semibold text-[#0E2F44]"
                            >
