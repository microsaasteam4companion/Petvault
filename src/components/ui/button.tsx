  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground rounded-pill shadow-card hover:shadow-card-hover hover:-translate-y-0.5 font-semibold",
        "hero-outline": "border-2 border-primary-foreground text-primary-foreground bg-transparent rounded-pill hover:bg-primary-foreground/10 font-semibold",
        nav: "bg-accent text-accent-foreground rounded-pill font-semibold hover:bg-accent/80",
      },
      size: {
